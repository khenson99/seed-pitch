    ...
    <Slide>
      <div style={{ height: '100%', display: 'flex', flexDirection: 'column' }}>
        ...
        <div className="responsive-stack" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 'var(--spacing-3xl)', flex: 1, alignItems: 'start' }}>
          ...
          <div className="responsive-full-width box-card" style={{ padding: 'var(--spacing-xl)', border: '1px solid var(--color-border)', borderRadius: '12px', backgroundColor: '#fff', boxShadow: '0 4px 6px rgba(0,0,0,0.02)' }}>

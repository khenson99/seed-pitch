  ...
  return (
    <Slide>
      <div style={{ height: '100%', display: 'flex', flexDirection: 'column' }}>
        ...
        <div className="responsive-stack" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 'var(--spacing-3xl)', alignItems: 'start', flex: 1 }}>
           {/* Section 1: The Waste */}
           <motion.div className="responsive-full-width" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }}>
           ...
           {/* Section 2: The Quote */}
           <motion.div className="responsive-full-width" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.4 }} style={{ borderLeft: '1px solid var(--color-border)', paddingLeft: 'var(--spacing-2xl)' }}>
